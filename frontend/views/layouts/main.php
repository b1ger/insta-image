...
<?php $this->beginPage() ?>
                ...
                <div class="container">
                    ...
                    <div class="col-md-4 col-sm-4 navicons-topbar">
                        <ul>
                            ...
                            <li>
                                <?php echo Html::beginForm('/site/language'); ?>
                                <?php echo Html::dropDownList('language', Yii::$app->language, ['en-US' => 'English', 'ru-RU' => 'Руский']); ?>
                    ...
                    <div class="main-nav-wrapper">
                        <nav class="main-menu">
                            ...
                            if (Yii::$app->user->isGuest) {
                                ...
                                $menuItems[] = ['label' => Yii::t('menu', 'About'), 'url' => ['/site/about']];
                            } else {
    ...
    <footer>
        <div class="footer">
            ...
            <p class="text">Images | <?php echo date("Y", time())?></p>
        </div>
    </footer>
